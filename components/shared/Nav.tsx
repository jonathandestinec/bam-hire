...
function Nav() {
  ...
  return (
    <nav className='fixed shadow-md inset-0 bg-[#00283c] text-white h-[100px]  flex items-center p-[15px] justify-between'>
        <Link href="/"><h1 className='font-bold text-xl'>Logo</h1></Link>
