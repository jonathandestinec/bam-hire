...
export default function PrivacyPolicy() {
    return (
        <div style={{ padding: '40px', backgroundColor: '#121212', color: '#ffffff', fontFamily: 'Arial, sans-serif', lineHeight: '1.8' }}>
            <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                <h1 style={{ textAlign: 'center', marginBottom: '20px', fontSize: '2.5rem', color: '#00ADB5' }}>Privacy Policy</h1>
                <p>
                ...
                <section style={{ marginTop: '30px' }}>
                    <h2 style={{ fontSize: '1.8rem', color: '#00ADB5' }}>1. Information We Collect</h2>
                ...
                <section style={{ marginTop: '30px' }}>
                    <h2 style={{ fontSize: '1.8rem', color: '#00ADB5' }}>2. How We Use Your Information</h2>
                    <ul style={{ paddingLeft: '20px', listStyleType: 'disc' }}>
                ...
                <section style={{ marginTop: '30px' }}>
                    <h2 style={{ fontSize: '1.8rem', color: '#00ADB5' }}>3. How We Share Your Information</h2>
                    <p>
                ...
                <section style={{ marginTop: '30px' }}>
                    <h2 style={{ fontSize: '1.8rem', color: '#00ADB5' }}>4. Your Choices and Rights</h2>
                    <ul style={{ paddingLeft: '20px', listStyleType: 'disc' }}>
                ...
                <section style={{ marginTop: '30px' }}>
                    <h2 style={{ fontSize: '1.8rem', color: '#00ADB5' }}>5. How We Protect Your Information</h2>
                    <p>
                ...
                <section style={{ marginTop: '30px' }}>
                    <h2 style={{ fontSize: '1.8rem', color: '#00ADB5' }}>6. Third-Party Links</h2>
                    <p>
                ...
                <section style={{ marginTop: '30px' }}>
                    <h2 style={{ fontSize: '1.8rem', color: '#00ADB5' }}>7. Children's Privacy</h2>
                    <p>
                ...
                <section style={{ marginTop: '30px' }}>
                    <h2 style={{ fontSize: '1.8rem', color: '#00ADB5' }}>8. Changes to This Policy</h2>
                    <p>
                ...
                <section style={{ marginTop: '30px' }}>
                    <h2 style={{ fontSize: '1.8rem', color: '#00ADB5' }}>9. Contact Us</h2>
